...
class Grid:
    ...
    def __init__(self, rows, cols, width, height, win):
        self.rows = rows
        self.cols = cols
        self.cells = [[Cell(self.grid[i][j], i, j, width, height)
    ...
    def update_model(self):
        self.model = [[self.cells[i][j].value for j in range(
    ...
    def draw(self):
        ...
        for i in range(self.rows+1):
            if i % 3 == 0 and i != 0:
                ...
                thick = 1
            pygame.draw.line(self.win, (150, 150, 150), (0, i*gap),
                             (self.width, i*gap), thick)
            pygame.draw.line(self.win, (150, 150, 150), (i * gap, 0),
...
class Cell:
    ...
    def draw_change(self, win, g=True):
        ...
        # colour for winning cells
        pygame.draw.rect(win, (53, 53, 53), (x, y, gap, gap), 0)
...
def main():
    ...
    pygame.display.set_caption("Samir's Sudoku")
